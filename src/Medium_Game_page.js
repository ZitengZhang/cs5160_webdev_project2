...
export default class Medium_Game_page extends React.Component{
    ...
    checkSet(){
        ...
        if(this.isSet(firstCard,secondCard,thirdCard))
        {
            ...
            while(this.canFindSet()===false){
                this.addThreeCard();
                this.setState({
                    showSelectedResult:"Automatically Drawn "
                })
